    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <Label className="text-base font-semibold">How do you want to split?</Label>
          <Tabs
            defaultValue="equal"
          ...
          >
            <TabsList className="grid w-full grid-cols-3 bg-muted/50 p-1">
              <TabsTrigger
                value="equal"
                className="data-[state=active]:bg-white data-[state=active]:text-amber-700 data-[state=active]:shadow-sm data-[state=active]:font-semibold"
              >
                Equal
              </TabsTrigger>
              <TabsTrigger
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t mt-8">
        <div className="flex flex-col">
          ...
          <span className="text-3xl font-bold">₹{parseFloat(amountValue || 0).toFixed(2)}</span>
        </div>

        <Button
          type="submit"
          size="lg"
          className="w-full sm:w-auto px-8 bg-amber-500 hover:bg-amber-600 text-white font-semibold shadow-md"
